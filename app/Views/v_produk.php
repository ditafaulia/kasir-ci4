            ...
            <div class="card card-primary ">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <button class="btn btn-tool" data-toggle="modal" data-target="#add-data"><i class="fas fa-plus"></i>Tambah Data
                  </button>
                </div>
                <!-- /.card-tools -->
              </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="form-group">
                ...
                <input name="kode_produk" class="form-control" value='<?= old('kode_produk') ?>' placeholder="kode_produk" required>
              </div>

              <div class="form-group">
                <label for="">Nama_produk</label>
                <input name="nama_produk" class="form-control" value='<?= old('nama_produk') ?>' placeholder="nama_produk" required>
              </div>
            ...
            <div class="modal-footer justify-content-between">
              <button type="button" class="btn btn-default btn-flat"data-toggle="modal" data-target="#edit-data" data-dismiss="modal">Close</button>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="form-group">
                ...
                <label for="">kode produk</label>
                <input name="kode_produk" class="form-control" value='<?= $value['kode_produk'] ?>' placeholder="kode_produk" readonly>
              </div>

              <div class="form-group">
                <label for="">Nama_produk</label>
                <input name="nama_produk" class="form-control" value='<?= $value['nama_produk']?>' placeholder="nama_produk" required>
              </div>
...
<?php foreach ($produk as $key => $value) { ?>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
             Apakah Anda Yakin Untuk Menghapus <b><?= $value['nama_produk'] ?></b>
            </div>
            <div class="modal-footer justify-content-between">
              <button type="button" class="btn btn-default btn-flat"  data-dismiss="modal"<i class="fas fa-plus">Close</button>
