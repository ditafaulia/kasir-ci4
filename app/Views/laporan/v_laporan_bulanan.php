...
<script>
    ...
    function PrintLaporan(){
        ...
        if (bulan == "") {
            ...
            NewWin=window.open('<?=base_url('Laporan/PrintLaporanBulanan')?>/' + bulan + '/' + tahun,'NewWin','toolbar=no,width=1000,height=500,scrollbars=yes');
        }
    }
</script>