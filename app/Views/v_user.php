        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="form-group">
                ...
                <input name="Nama_user" class="form-control" value="<?= $value['id_user'] ?>" placeholder="Nama user" required>
              </div>
              ...
              <div class="form-group">
                <label for="">Password</label>
                <input name="password" class="form-control" value="<?= $value['password'] ?>" placeholder="user" readonly>
              </div>
