    ...
    <div class="content">
        <div class="row">
          ...
          <div class="col-lg-5">
            <div class="card card-primary card-outline">
              ...
              <div class="card-body bg-white color-palette text-right">
        ...
        <div class="col-lg-12">
            <div class="card card-primary card-outline">
              ...
              <div class="card-body bg-white color-palette text-center">
        ...
        <div class="modal-dialog modal-sm">
          <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button class="btn btn-primary btn-flat"><i class="fas fa-save"></i>Save Transaction</button>
            </div>
            <?php echo form_close() ?>
          </div>
  <!-- Modal-content  -->
