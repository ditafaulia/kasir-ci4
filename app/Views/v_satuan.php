          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="form-group">
                <label for="">NamaSatuan</label>
                <input name="Nama_satuan" class="form-control" placeholder="Satuan" required>
              </div>
            </div>
            <div class="modal-footer justify-content-between">
              <button type="button" class="btn btn-default btn-flat"data-toggle="modal" data-target="#edit-data" data-dismiss="modal"<i class="fas fa-plus">Close</button>
      ...
      <?php foreach ($satuan as $key => $value) { ?>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
             Apakah Anda Yakin Untuk Menghapus <b><?= $value['nama_satuan'] ?></b>
            </div>
            <div class="modal-footer justify-content-between">
